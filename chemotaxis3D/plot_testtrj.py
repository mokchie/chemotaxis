...
fig1,(ax1,ax3,ax5) = plt.subplots(3, 1, sharex=True)
fig2,ax246 = plt.subplots(1, 1, sharex=True)
axs = (ax1,ax3,ax5)
filenames = ['test1-sw-epoch-1.data','test2-sw-epoch-1.data','test3-sw-epoch-1.data']
labels = ['2','4','8']
colors = ['C0','C1','C2']
direct = "data"
k0 = 4.0
...
for j,filename in enumerate(filenames):
    ...
    ax246.plot(Time,C,color=colors[j],label=labels[j])
...
ax246.legend(loc = 'upper left')
ax1.set_ylabel(r'$\kappa$')
ax246.set_xlabel('$t$')
ax246.set_ylabel(r'$c$')
#ax3.set_xlabel('$t$')
